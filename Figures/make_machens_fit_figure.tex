...
\begin{axis}
       [
         ...
         xtick           = {1, 3}         ,
         xticklabels	 = {0, 2}		  , % Change tick labels so thta delta F over F is correct unit
         ytick           = {1, 3}         ,
         yticklabels	 = {0, 2}		  ,
         tick pos        = left           ,
         xlabel={pop. A activity  ($\Delta F/F$)},
         ylabel = {pop. B activity  ($\Delta F/F$)},
         xmin=0.8,xmax=3.2,
         ymin=0.8,ymax=3.2
       ]
...
quiver={u=\thisrowno{2},v=\thisrowno{3}, 
	...
	every arrow/.append style={%
		...
		gray, ->, >=stealth, mark options={scale=0.11}
] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line1_ind00.csv};

\addplot [no markers, black, thick, dashed] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line2_ind00.csv};

\addplot [no markers, black, thick, dotted] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line3_ind00.csv};
...
\addplot [
    ...
    ] table [x index=0, y index=1, meta index=2, col sep=comma]{CSV/figure_4_5_gpfit_line4_ind00.csv};
...
\node[draw=none, fill=none] at (2.85,4.8) {\large $E_{ext}=2.3$ nS};
%\node[draw=none, fill=none] at (2.05,3.4) {\large $\sigma=0.2$};
\begin{axis}
       [
         axis line style = { draw = none },
...
\addplot [
quiver={u=\thisrowno{2},v=\thisrowno{3}, scale arrows=0.4}, 
gray, ->, >=stealth, mark options={scale=0.2}
] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line1_ind01.csv};

\addplot [no markers, black, thick, dashed] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line2_ind01.csv};

\addplot [no markers, black, thick, dotted] table [x index=0, y index=1, col sep=comma, mark=circle]{CSV/figure_4_5_gpfit_line3_ind01.csv};
...
\addplot [
    ...
    ] table [x index=0, y index=1, meta index=2, col sep=comma]{CSV/figure_4_5_gpfit_line4_ind01.csv};
